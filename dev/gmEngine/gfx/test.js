...
const domRoomImg = document.createElement('img');
domRoomImg.src = roomImg.data;
document.body.appendChild(domRoomImg);
...
const domTSet = document.createElement('img');
domTSet.src = tSet.src;
document.body.appendChild(domTSet);
...
const testLoop = ()=>{
  ...
  for(let j = 0; j < 4; j++){
    for (let i = 0; i < 4; i++) {
      _gfx.spr(0, 1 + i + j * 4, i * 34 - 96, - j * 34 -56);
    }
  }
